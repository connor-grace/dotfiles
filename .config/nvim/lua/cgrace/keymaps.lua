...
vim.keymap.set("n", "<leader>pv", vim.cmd.Ex, { desc = "Explorer", silent = true })
...
vim.keymap.set({ "i", "n" }, "<C-c>", "<cmd>noh<cr><Esc>", { desc = "Esc and clear hlsearch" })
...
vim.keymap.set("n", "<leader>fx", "<cmd>!chmod +x %<CR>", { desc = "Make file executable", silent = true })

return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      -- Completion capabilities via blink.cmp
      'saghen/blink.cmp',
    },
    config = function()
      ...
      --  blink.cmp provides additional completion capabilities to advertise to servers.
      ...
      -- Install external tools/servers via Mason
